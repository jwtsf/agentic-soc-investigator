...
- Modify `src/soc_investigator/config/agents.yaml` to define your agents
- Modify `src/soc_investigator/config/tasks.yaml` to define your tasks
- Modify `src/soc_investigator/crew.py` to add your own logic, tools and specific args
- Modify `src/soc_investigator/main.py` to add custom inputs for your agents and tasks
...
This command initializes the soc_investigator Crew, assembling the agents and assigning them tasks as defined in your configuration.
...
For support, questions, or feedback regarding the SocInvestigator Crew or crewAI.
